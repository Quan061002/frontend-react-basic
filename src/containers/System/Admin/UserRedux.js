...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.listUser !== this.props.listUsers) {
            let arrGenders = this.props.genderRedux;
            let arrRoles = this.props.roleRedux;
            let arrPositions = this.props.positionRedux;
    ...
    checkValidateInput = () => {
        let isValid = true;
        let arrCheck = ['email', 'passwoord', 'firstName', 'lastName', 'address', 'phonenumber']
            ...
            <div className="user-redux-container">
                ...
                <div className="user-redux-body">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 my-3"><FormattedMessage id="manage-use.add"/></div>
                            ...
                            <div className="col-3">
                                <label><FormattedMessage id="manage-use.first-name"/></label>
                            ...
                            <div className="col-3">
                                <label><FormattedMessage id="manage-use.last-name"/></label>
                                <input className="form-control" type="text"
                                       value = {lastName}
                            ...
                            <div className="col-3">
                                <label><FormattedMessage id="manage-use.phone-number"/></label>
                                <input className="form-control" type="text"
                                       value = {phoneNumber}
